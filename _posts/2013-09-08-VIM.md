...
![Sublime Text Fuzzy Search](http://www.integralist.co.uk/Assets/Images/sublime-text-fuzzy.png)
...
![pure zsh](http://www.integralist.co.uk/Assets/Images/pure-zsh.png)
...
![tmux](http://www.integralist.co.uk/Assets/Images/tmux.png)
...
![tmux horizontal pane](http://www.integralist.co.uk/Assets/Images/tmux-horizontal.png)

To create a new vertical pane run the prefix command and then press `Shift+'` (the `"` key).

![tmux vertical pane](http://www.integralist.co.uk/Assets/Images/tmux-vertical.png)
...
![tmuxinator](http://www.integralist.co.uk/Assets/Images/tmuxinator.png)
...
![Ctrl+P](http://www.integralist.co.uk/Assets/Images/ctrlp.png)
...
![NERDTree](http://www.integralist.co.uk/Assets/Images/nerdtree.png)
