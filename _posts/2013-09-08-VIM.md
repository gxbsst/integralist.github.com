...
- Sparkup (ZenCoding/Emmet) [http://net.tutsplus.com/tutorials/other/vim-essential-plugin-sparkup/](NetTuts Screencast)
- Snipmate [http://net.tutsplus.com/tutorials/other/vim-essential-plugin-snipmate/](NetTuts Screencast)
