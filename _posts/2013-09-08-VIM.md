...
![Sublime Text Fuzzy Search](/Assets/Images/sublime-text-fuzzy_1024.png)
...
![pure zsh](/Assets/Images/pure-zsh_1024.png)
...
![tmux](/Assets/Images/tmux_1024.png)
...
![tmux horizontal pane](/Assets/Images/tmux-horizontal_1024.png)

To create a new vertical pane run the prefix command and then press `Shift+'` (the `"` key).

![tmux vertical pane](/Assets/Images/tmux-vertical_1024.png)
...
![tmuxinator](/Assets/Images/tmuxinator_1024.png)
...
![Ctrl+P](/Assets/Images/ctrlp_1024.png)
...
![NERDTree](/Assets/Images/nerdtree_1024.png)
