{
  ...
  date:  "2012-04-22",
  description: "Surprising how difficult it is for developers to understand the difference between 'host' methods and 'native' methods. Hopefully this post helps clear up any confusion."
}
