{
  ...
  date:  "2013-08-04",
  description: "Quick run down of using PhantomJS to generate an ApplicationCache manifest file (covers different aspects of Phantom's API). This code has now been open sourced as <a href='https://github.com/Integralist/Squirrel'>Squirrel</a>"
}
