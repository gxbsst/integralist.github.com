{
  ...
  date:  "2013-06-21",
  description: "This is a continuation from my previous Grunt post where I was trying to dynamically update the main Grunt file at runtime. Seems there is a better (and more official) way to do this using aspects of the Grunt API"
}
