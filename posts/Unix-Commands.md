{
  title: "Unix Commands",
  date:  "2013-10-01",
  description: "I've started to realise the beauty and efficiency that is the Unix Philosophy and so this post covers how to take advantage of a few common shell commands that you should find quite useful. Covers commands such as Awk, Sed, Grep, Cut, Xargs and more."
}
